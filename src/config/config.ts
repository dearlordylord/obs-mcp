...
const Toolset = Schema.Literal("events", "general", "inputs", "outputs", "record", "scenes", "stream")
...
const parseToolsets = (value: string | undefined): ReadonlyArray<Toolset> => {
  ...
  const allowed = new Set<string>(["events", "general", "inputs", "outputs", "record", "scenes", "stream"])
