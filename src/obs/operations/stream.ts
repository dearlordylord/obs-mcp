...
import { acknowledged, outputActive, requestAndDecode, requestAndReturn } from "./shared.js"
...
export const sendStreamCaption = async (
  ...
  return SendStreamCaptionOutput.make(acknowledged(SendStreamCaption.requestType))
}
